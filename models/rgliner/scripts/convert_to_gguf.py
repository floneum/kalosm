...
Usage:
    python scripts/convert_to_gguf.py --model knowledgator/gliner-bi-edge-v2.0 --output gliner-bi-edge-v2.0.gguf
...
# GGUF/GGML constants, quant tables and the GGUFWriter live in the shared module.
from gguf_common import *  # noqa: F401,F403
