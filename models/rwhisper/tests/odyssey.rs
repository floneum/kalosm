...
#[test]
fn transcribe_the_odyssey() -> Result<(), anyhow::Error> {
    tracing_subscriber::fmt::init();
    // First download the audio file from the internet using a blocking client
    // so the test doesn't depend on a tokio runtime.
