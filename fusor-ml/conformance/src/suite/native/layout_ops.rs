...
pub async fn shape_and_layout_ops_match_host_reference() -> CaseResult {
...
pub async fn tensor_i_op_matches_expected_views() -> CaseResult {
...
pub async fn broadcast_as_non_contiguous_input_matches_expected_view() -> CaseResult {
    for device in available_devices().await {
...
pub async fn sliding_window_then_transpose_then_reshape_matches_expected() -> CaseResult {
    use fusor_types::SlidingWindow;
...
pub async fn transpose_reshape_consumed_by_elementwise_matches_expected() -> CaseResult {
...
pub async fn sliding_window_with_cat_padding_matches_expected() -> CaseResult {
    use fusor_types::SlidingWindow;
...
pub async fn restride_and_restride_layout_match_expected_views() -> CaseResult {
...
pub async fn cat_stack_and_chunk_match_expected_views() -> CaseResult {
