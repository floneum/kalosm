...
registry! {
    ...
    elementwise_ops::large_tensor_unary_ops_fuzzed,
    ...
    flash_attention_ops::flash_attention_f16_matches_cpu_reference_on_varied_shapes,
    flash_attention_ops::flash_attention_f16_with_qk_mask_matches_cpu_reference,
    flash_attention_ops::flash_attention_gqa_matches_cpu_reference_on_varied_shapes,
    flash_attention_ops::flash_attention_matches_cpu_reference_on_varied_shapes,
    flash_attention_ops::flash_attention_subgroup_fallback_preserves_gpu_backend,
    flash_attention_ops::flash_attention_tiled_matches_cpu_reference_on_varied_shapes,
    flash_attention_ops::flash_attention_tiled_with_mask_matches_cpu_reference,
    flash_attention_ops::flash_attention_with_batch_key_mask_matches_cpu_reference_on_varied_shapes,
    ...
    matmul_conv_pool::matmul_large_fuzzed,
    ...
    quantized_matmul::f16_q_matrix_q_mat_mul_matches_host_reference,
    quantized_matmul::f32_q_matrix_q_mat_mul_matches_host_reference,
    ...
    quantized_matmul_batched::q_mat_mul_batched_3d_matches_host_reference,
    ...
    quantized_matmul_batched::q_mat_mul_transposed_input_matches_host_reference,
    ...
    quantized_matmul_fusion::q8_0_qmatmul_post_mixed_extras_preserves_binding_order,
    ...
    quantized_matmul_paired::q4k_concat_split_swiglu_matches_cpu_reference,
    ...
    rank_and_empty::rank4_max_min_match_reference,
    rank_and_empty::rank4_mean_axis0_matches_reference,
    rank_and_empty::rank4_rms_norm_fused_matches_reference,
    rank_and_empty::rank4_softmax_last_dim_matches_reference,
    rank_and_empty::rank4_sum_per_axis_matches_reference,
    reductions_indexing::full_tensor_reductions_fuzzed,
