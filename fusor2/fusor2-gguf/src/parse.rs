...
impl GgufValue {
    ...
    /// Best-effort unsigned read, for callers that only want a number.
...
/// fusor2 cannot ingest too, because the tensor directory must stay walkable
...
impl GgufMetadata {
    ...
    pub fn read<R: Read + Seek>(reader: &mut R) -> Result<Self> {
        ...
        for _ in 0..tensor_count {
            ...
            // GGUF is fastest-varying-first; fusor2 is row-major.
            shape.reverse();
            let tag = read_le_u32(reader)?;
